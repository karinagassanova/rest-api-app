...
import Ajv from "ajv";
import {MovieCastQueryParams, MovieCast, MovieCastResponse} from '../shared/types'

const ajv = new Ajv();
const isValidCastQuery = ajv.compile<MovieCastQueryParams>(
...
export const handler: APIGatewayProxyHandlerV2 = async (event, context) => {
  try {
    ...
    if (!isValidCastQuery(queryParams)) {
      return {
        statusCode: 500,
        headers: {
          "content-type": "application/json",
